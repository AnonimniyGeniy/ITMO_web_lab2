...
<jsp:useBean id="points" class="models.PointDataList" scope="session"/>
...
<head>
    <meta charset="UTF-8">
    <title>lab1</title>
    <script src="scripts/val_and_sub.js"></script>
...
<div id="result_table" class="result_class">
    <table class="result_table">
        ...
        <tbody>
        <c:forEach var="pointData" items="${points.pointDataList}">
            <tr>
                <td>${pointData.x}</td>
                <td>${pointData.y}</td>
                <td>${pointData.r}</td>
